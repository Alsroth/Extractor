...
class DurationTest {
    ...
    @Test
    void test_plus_additionne_une_duree_en_minute_sur_une_duree_dépassant_60minute() {
        // Given
    ...
    @Test
    void test_plus_additionneUneSecpndeAUneDureeAvec59MinuteEt59Secondes_AlorsRetourneLaBonneDuree() {
        // Given
        Duration duration = new Duration(5, 59, 59.0);

        duration.plus(new Duration(0, 0, 1.0));

        // When && then
        Assertions.assertEquals(new Duration(6, 0, 0.0), duration);
